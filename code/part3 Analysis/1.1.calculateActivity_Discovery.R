...
##NetBID analysis of Discovery cohort
...
draw.eset.QC(eset = eset,outdir="./QC/Discovery",intgroup='condition',do.logtransform=FALSE,prefix='after_QC_')
...
Discovery_ac.eset <- NetBID2::generate.eset(exp_mat=ac_mat,phenotype_info=pData(eset)[colnames(ac_mat),],feature_info=NULL,annotation_info='TARGETnet')
NetBID2::draw.eset.QC(eset=Discovery_ac.eset,outdir="./QC/Discovery",intgroup='condition',do.logtransform=FALSE,prefix='AC_')

save(Discovery_ac.eset,file = "./DATA/Discovery/Discovery_ac.eset")
save(Discovery_cal.eset,file = "./DATA/Discovery/Discovery_cal.eset")
